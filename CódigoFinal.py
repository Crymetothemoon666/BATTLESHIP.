...
def turnos_dos_jugadores(tablero_hits,tablero_usuario,nombre):
    ...
    if tablero_hits == tablero_hits:
        fila, columna = entrada_de_usuario(tablero_hits)
...
print ('By: Alejandro Granados Moncayo y Jonathan Anell Segovia'.center(865))
    ...
    if eleccion == 1:
        ...
        if modo_de_juego == 1:
            ...
            if turnos_jugador >=17:
                ...
                print('Tablero de la IA con barcos')
                impresion_del_tablero(TABLERO_DE_LA_IA)
                turnos_IA = turnos_jugador
            ...
            if modos_de_juego_player_vs_player == 1:
                ...
                if turnos_jugador_uno >= 17 :
                    ...
                    impresion_del_tablero(TABLERO_DEL_JUGADOR_DOS)
                    ...
                    while (contador_de_hits(TABLERO_DE_HITS_JUGADOR_UNO) < 99 and contador_de_hits(TABLERO_DE_HITS_JUGADOR_DOS) < 99):
                        ...
                        if contador_de_hits(TABLERO_DE_HITS_JUGADOR_UNO) == 2:
                            print(nombre_j1.center(865))
                            print("¡¡LA VICTORIA ES TUYA!!".center(865))
                            print(final_hits_jugador1.center(865))
                            break   
                        elif contador_de_hits(TABLERO_DE_HITS_JUGADOR_DOS) == 2:
                            print(nombre_j2.center(865))
                            print("¡¡LA VICTORIA ES TUYA!!".center(865))
                ...
                print(('Tablero del jugador:' + ' ' + nombre_1).center(865))
                posicion_de_los_barcos_random(TABLERO_DEL_JUGADOR_UNO)
                print(('Tablero del jugador:' + ' ' + nombre_2).center(865))
                ...
                while (contador_de_hits(TABLERO_DE_HITS_JUGADOR_UNO) < 99 and contador_de_hits(TABLERO_DE_HITS_JUGADOR_DOS) < 99):
                    ...
                    contador2 = nombre_2 + ' ' + 'te quedan' + ' ' + str(turnos_jugador_uno) +  ' ' + 'balas'
        ...
        BOTON_DE_REGRESO = int(input('Si desear regresar al menu inserta un 1: '))
    elif eleccion==3: 
